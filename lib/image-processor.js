...
function writeJpeg(img) {
    var jpeg = img.compress("JPEG").quality(90);
        ...
        .then(
            function (result) {
                ...
                if (result.transparencyMistake) {
                    result.message = "MINOR TRANSPARENCY MISTAKE: Image has just a few transparent pixels.";
                }
                ...
                if (isTransparent) 
                {
                    ...
                    if ((result.png / result.jpg) > 1.5 && colorCount > 64)
                    {
                        ...
                        result.message = "MAJOR TRANSPARENCY MISTAKE: Image has photographic and transparent elements.";
