...
var winRegex = /\\www\.[a-z\.]{2,6}\\/i;
var unixRegex = /\/www\.[a-z\.]{2,6}\//i;
...
// TODO: Reimplement this so that it can start at any point deep in the tree, and 
// gather the imagesettings at that level.
// Also, provide an option for it to search parallel language directories
// when starting deep in the tree.
...
exports.recurseDirSync = function (baseDir, fullPath) {
	...
	return recurseDirSync({ fullPath: fullPath, imageSettings: { format: "jpeg", quality: "80", type: "default", fullPath: null } });
};
